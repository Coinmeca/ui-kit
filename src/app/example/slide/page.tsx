...
export default function Exchange() {
    ...
    const tabs = [
        {
            ...
            children: (
                <Layouts.Row>
                    <Icon icon={"swap"} scale={0.5} title={"swap"} />
                    <Icon icon={"account"} scale={1} />
                    <Icon icon={"bank"} color={"#6080FF"} scale={2} />
                    <Icon icon={"chevron-left"} color={"yellow"} scale={3} />
                    <Icon icon={"chart-area"} color={"red"} scale={4} />
                    {/* <Icon icon={""} /> */}
                </Layouts.Row>
            ),
        },
    ...
    return (
        <Layouts.Content>
            <Layouts.Cover fullsize>{/* <Controls.Slide slides={slides} padding={0} timer={3000} align={"center"} nav={"bottom"} style={{ zIndex: 4 }} /> */}</Layouts.Cover>
            <Layouts.Box>
