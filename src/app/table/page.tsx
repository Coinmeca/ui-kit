...
export default function Exchange() {
                    ...
                    children: (
                        <>
                            <Layouts.Row fit style={{ padding: "0.5em 1em" }} gap={0}>
                                <Controls.Tab onClick={() => setSidebarTab("exchange")}>Exchange</Controls.Tab>
                                <Controls.Tab onClick={() => setSidebarTab("alert")}>Alert</Controls.Tab>
                                <Controls.Tab onClick={() => setSidebarTab("asset")}>Assets</Controls.Tab>
                            </Layouts.Row>
                            <Controls.Input icon="search" dropdown={{ options: list }} />
    ...
    return (
        <Frames.Frame sidebar={sidebars} align={"right"} background={{ filter: "black", img: { src: 2 } }}>
            <Layouts.Content>
