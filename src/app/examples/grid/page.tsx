		...
		<Layouts.Page>
			<Layouts.Box fit>
				<Layouts.Row gap={0}>
					...
					<Controls.Tab active={grid === 2} onClick={() => setGrid(2)}>
						Format(Component)
					</Controls.Tab>
					<Controls.Tab active={grid === 3} onClick={() => setGrid(3)}>
						No Format
					</Controls.Tab>
					<Controls.Tab active={grid === 4} onClick={() => setGrid(4)}>
						As Children(Row)
					</Controls.Tab>
					<Controls.Tab active={grid === 5} onClick={() => setGrid(5)}>
						As Children(Col)
					</Controls.Tab>
					<Controls.Tab active={grid === 6} onClick={() => setGrid(6)}>
						For Sample
					</Controls.Tab>
				</Layouts.Row>
				<Layouts.Contents.TabContainer
					contents={[
						...
						{
							active: grid === 4,
							children: <Layouts.Contents.InnerContent>{Grid4}</Layouts.Contents.InnerContent>
						},
						{
							active: grid === 5,
							children: <Layouts.Contents.InnerContent>{Grid5}</Layouts.Contents.InnerContent>
						},
						{
							active: grid === 6,
							children: (
