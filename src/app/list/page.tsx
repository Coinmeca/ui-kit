...
export default function Exchange() {
    ...
    return (
        <Frames.Frame sidebar sidebars={sidebars} background={{img:{src: 2}}}>
            <Layouts.Content>
